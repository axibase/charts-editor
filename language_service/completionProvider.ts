...
export class CompletionProvider {
    ...
    protected readonly currentLine: string;
     ...
     */
    protected completeFor(): CompletionItem {
...
for \${1:${item}} in \${2:${collection}}
  ...
  \${0}
     ...
     */
    protected completeIf(): CompletionItem[] {
...
\${0}`;
     ...
     */
    protected completeSettingName(): CompletionItem[] {
     ...
     */
    protected completeSettingValue(settingName: string): CompletionItem[] {
     ...
     * @returns array containing snippets
     */
    protected completeSnippets(): CompletionItem[] {
     ...
     * @returns array containing completions
     */
    protected completeStringSettingValue(setting: Setting): CompletionItem[] {
     ...
     * @returns completion
     */
    protected fillCompletionItem(itemFields: ItemFields): CompletionItem {
     ...
     * @returns completions
     */
    protected getItemsArray(processedArray: string[], ...additionalStrings: string[]): CompletionItem[] {
